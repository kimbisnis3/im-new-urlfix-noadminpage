...
function __construct(){
	...
	$this->load->model('M_syaratdanketentuan'); 
	...
	{	
		...
		#konten
		$data['msyaratdanketentuan'] = $this->M_syaratdanketentuan->show();
		$this->load->view('syaratdanketentuan/v_syaratdanketentuan',$data);
