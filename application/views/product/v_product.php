        ...
        <div class="price-section price-section--withTax" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
			...
			<span data-product-price-with-tax class="price price--withTax">
				<form id="form" action="<?php echo base_url('shop/add'); ?>" method="post">
					...
					<button type="button" id="form-action-addToCart" data-wait-message="Adding to cart…" class="button button--primary" onclick="addcart(<?php echo $t->id; ?>)">Add To Cart</button>
				</form>
