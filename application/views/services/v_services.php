<div class="body">
	...
	<div class="container">
		...
		<ul class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
			...
			<li class="breadcrumb " itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
				<a href="" class="breadcrumb-label" itemprop="item">Services</a>
				<meta itemprop="position" content="1" />
			</li>
		</ul>
		<main class="page">
			<?php foreach ($mservices as $t) { ?>
			<h1 class="page-heading"><?php echo $t->judul; ?></h1>
			<div class="page-content page-content--centered">
				<img style="width: 50%; margin: 0 auto;" src="<?php echo base_url('gopanel/uploads/services/'.$t->image); ?>">
