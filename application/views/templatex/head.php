...
<!-- css -->
<link rel="icon" href="<?php echo base_url ('gambar/im.png') ?>" type="">
<link href="https://fonts.googleapis.com/css?family=Boogaloo|Bree+Serif" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/several/css/fontello.css'); ?>">
<link href="<?php echo base_url('assets/css/bootstrap.css'); ?>" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="<?php echo base_url('assets/shop/css/cms-custom-style.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/shop/css/cms.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/shop/css/shopping.css') ?>">
<style type="text/css">

.top-products {
    background-image: url('<?php echo base_url('gambar/dirt5x.png'); ?>');
}
...
.form-control:focus {
    border-color: #2D949D;
    box-shadow: 0 1px 1px rgba(229, 103, 23, 0.075) inset, 0 0 2px #2D949D;
    outline: 0 none;
}
...
.wmuSliderPagination a.wmuActive {
	background: #2D949D;
    box-shadow: 0px 0px 10px #2D949D;
	-webkit-box-shadow: 0px 0px 10px #2D949D;
	-moz-box-shadow: 0px 0px 10px #2D949D;
	-o-box-shadow: 0px 0px 10px #2D949D;
	-ms-box-shadow: 0px 0px 10px #2D949D;
}
/* Default Skin */
...
#PPsbmincart form  ul::-webkit-scrollbar-thumb {
    ...
    border-radius: 10px;
    background: #2D949D;
	-moz-box-shadow: inset 0 0 6px #2D949D;
	-o-box-shadow: inset 0 0 6px #2D949D;
	-ms-box-shadow: inset 0 0 6px #2D949D;
    -webkit-box-shadow: inset 0 0 6px #2D949D;
	box-shadow: inset 0 0 6px #2D949D;
}
/*-- //cart-css --*/
